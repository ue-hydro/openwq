...
void OpenWQ_initiate::setIC_phreeqc(
    ...
    nc = OpenWQ_wqconfig.phreeqcrm->GetComponentCount();
    ...
    OpenWQ_wqconfig.phreeqcrm->InitialPhreeqc2Module(ic1);
    OpenWQ_wqconfig.phreeqcrm->SetTime(0.0);
    OpenWQ_wqconfig.phreeqcrm->SetTimeStep(0);
    result = OpenWQ_wqconfig.phreeqcrm->RunCells();
