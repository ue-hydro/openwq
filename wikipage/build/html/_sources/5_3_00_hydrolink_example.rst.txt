    ...
    void CLASSWQ_openwq::run(
        ...
        if (OpenWQ_hostModelconfig.interaction_step > 1){
            ...
            for(unsigned int hru = 0; hru < nhru; ++hru) {
                ...
                for(unsigned int Sub_i = 0; Sub_i < OpenWQ_wqconfig.CH_model->BGC_general_mobile_species.size(); ++Sub_i) {
                    ...
                    Sub_mob = OpenWQ_wqconfig.CH_model->BGC_general_mobile_species[Sub_i];
