...
The Transport file is a JSON file that defines both the transport and mobilization of species within hydrological compartments and at their interface.

**Principal Key 1**: ``MODULE_NAME``

+--------------------+----------------------------------------------------------------------------------------------------------------------------+
| ``MODULE_NAME``    | - Select the module name desired                                                                                           |
|                    | - Options: ``OPENWQ_NATIVE_TRANSP_DISS_ADVDISP``, ``OPENWQ_NATIVE_TRANSP_DISS_ADV`` or ``OPENWQ_NATIVE_TRANSP_DISS_NONE``  |
+--------------------+----------------------------------------------------------------------------------------------------------------------------+
...
+---------------------------------------------------------------+--------------------------------------------------------------------+
| ``(i#)`` -> ``LOWER_COMPARTMENT``                             | Name of the lower compartment, e.g., ``"ILAYERVOLFRACWAT_SOIL"``   |
+---------------------------------------------------------------+--------------------------------------------------------------------+
