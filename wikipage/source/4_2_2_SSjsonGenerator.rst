...
While this file can be created manually (see :doc:`Source and Sink configuration <4_1_5Source>`), the following guidelines help generate it correctly.
...
The JSON structure follows the format described in :doc:`Source and Sink configuration <4_1_5Source>`.
