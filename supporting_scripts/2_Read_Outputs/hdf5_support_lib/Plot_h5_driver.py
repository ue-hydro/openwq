...
# Shared spatial-matching helpers (single source of truth: also used by the
# calibration prep + results report).  We re-export them under their
# previous underscore-prefixed names so the rest of this file (and any
# external callers that imported them) keep working without changes.
from spatial_matching import (
    haversine as _haversine,
    extract_coords as _extract_coords,
    polygon_rings as _polygon_rings,
    point_in_polygon as _point_in_polygon,
    polygon_centroid as _polygon_centroid,
    river_endpoint_degrees as _river_endpoint_degrees,
...
_DEBUG_EXT_META = {
    ...
    'd_output_dt_sorption': {'label': 'dC/dt sorpt',  'dash': 'dash'},
    'd_output_dt_transport_diss': {'label': 'dC/dt transp diss (water)', 'dash': 'dot'},
    'd_output_dt_transport_part': {'label': 'dC/dt transp part (sediment)', 'dash': 'dot'},
    'd_output_sed_mobilized': {'label': 'dM/dt mobilized (erosion)', 'dash': 'dash'},
    'd_output_sed_transport': {'label': 'dM/dt transport (routing)', 'dash': 'dot'},
