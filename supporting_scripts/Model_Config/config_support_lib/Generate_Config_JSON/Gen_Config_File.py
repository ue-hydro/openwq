...
bgc_jsonfile = '/media/dcosta/data/megasync/ec_main/models/openwq/code/internally_coupled/supporting_scripts/Generate_BGC_JSON_from_graphml/BGC_framework_examples/CRHM_soilNandP_cycle.json'
