...
#
# SECTIONS:
#   1. General Information (project, paths to executable & control file)
...
#   7. Output Settings
#   8. Model Execution (Docker/Apptainer)
#   9. Report Settings
#
...
# Path to the compiled executable on your machine (HOST path).
# All OpenWQ files (openwq_in/, openWQ_master.json, openwq_out/) are generated
# in the same directory as the executable.
# When using Docker/Apptainer, host paths are auto-converted to container paths.
executable_path = (
    "/Users/diogocosta/Documents/openwq_code/diogo_test/mizuRoute-OpenWQ/"
    "route/build/openwq/openwq/bin/mizuroute_openwq_Release"
)

# Path to the mizuRoute control file on your machine (HOST path).
file_manager_path = (
    "/Users/diogocosta/Documents/openwq_code/diogo_test/mizuRoute-OpenWQ/"
...
#   - executable_path and file_manager_path are set in Section 1 (as host paths)
#   - Host paths are auto-converted to container paths using docker-compose.yml
#     volume mapping (Docker) or the bind path (Apptainer)
