#!/bin/bash
# =============================================================================
# run_variant_B.sh — Production calibration: Variant B (SWAT Full Nutrients)
# =============================================================================
#
# 111 basins x 600 DDS evaluations
# 21 parameters (14 BGC + 7 SS)
# Template: SWAT_full_nutrients.json
#
# USAGE:
#   sbatch run_variant_B.sh
#   sbatch --array=0-50 run_variant_B.sh   # Only first 51 basins
#
# =============================================================================

#SBATCH --job-name=openwq_B
...
#SBATCH --output=slurm_logs/variant_B_%A_%a.out
#SBATCH --error=slurm_logs/variant_B_%A_%a.err
...
echo "========================================"
echo "VARIANT B: SWAT Full Nutrients"
echo "========================================"
