#!/bin/bash
# =============================================================================
# run_variant_A.sh — Production calibration: Variant A (Full N Cycle)
# =============================================================================
#
# 111 basins x 500 DDS evaluations
# 18 parameters (11 BGC + 7 SS)
# Template: nitrogen_full.json
#
# USAGE:
#   sbatch run_variant_A.sh
#   sbatch --array=0-50 run_variant_A.sh   # Only first 51 basins
#
# =============================================================================

#SBATCH --job-name=openwq_A
...
#SBATCH --output=slurm_logs/variant_A_%A_%a.out
#SBATCH --error=slurm_logs/variant_A_%A_%a.err
...
# Build basin list from directory names (sorted)
